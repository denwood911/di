...
#define STRING_CONFIG_H_AUTHOR "Trialon" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 320.00 // 320 get this value from auto calibrate
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0     // Y offset: -front +behind [the nozzle]
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -17.0  // Z offset: -below +above  [the nozzle]
